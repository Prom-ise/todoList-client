...
const Login = () => {
  ...
  <div className="app-name"><img src={logo} className="register-logo" alt="logo pic" /><p className="p">TODO LIST APPLICATION</p></div>
    ...
    <p className='text-gray-400'>Welcome back, glad to see you again Login to your account below.</p>
    ...
    <div className="remember-forgot">
      <label><input type="checkbox" /> Remember Me</label>
       <NavLink to="/todoList/forgotPassword" className='a'>
          Forgot Password?
        </NavLink>
    </div>
   ...
   <button
    ...
    <div className="register-link">
      <p>Don't have an account? <NavLink to="/todoList/register">Register</NavLink></p>
    </div>
  </form>
</div>
    </div>
